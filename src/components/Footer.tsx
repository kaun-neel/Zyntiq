        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-white/30 transition-colors enhanced-shadow">
              ...
              <a 
                ...
                className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-white/30 transition-colors enhanced-shadow"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@zyntiq.in" className="text-white hover:text-purple-300 transition-colors text-sm sm:text-base font-medium">
                  info@zyntiq.in
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="text-white flex-shrink-0" size={18} />
                <a href="tel:+11234567890" className="text-white hover:text-purple-300 transition-colors text-sm sm:text-base font-medium">
                  +1 (123) 456-7890
                </a>
              </li>
            </ul>
