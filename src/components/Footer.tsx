      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-800 mb-4 text-sm sm:text-base leading-relaxed font-medium">
            ...
            <ul className="space-y-2">
              {legalLinks.map((link) => (
                <li key={link.name}>
                  <Link 
                    to={link.path}
                    className="text-gray-800 hover:text-purple-800 transition-colors text-sm sm:text-base font-medium"
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="text-gray-800 mt-1 flex-shrink-0" size={18} />
                <span className="text-gray-800 text-sm sm:text-base font-medium">123 Education Ave, Learning City, ED 54321</span>
              </li>
        ...
        <div className="border-t border-gray-800/30 pt-6 sm:pt-8">
