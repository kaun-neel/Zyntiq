        ...
        <div className="hidden lg:flex items-center gap-3">
          {user ? (
            ...
            <>
              ...
              <Link
                to="/signup"
                className="px-4 py-2 rounded-full bg-gradient-to-r from-white/20 to-white/30 text-white hover:bg-white/40 backdrop-blur-sm transition-all duration-300 font-medium border border-white/20"
              >
                Sign up
              </Link>
            </>
